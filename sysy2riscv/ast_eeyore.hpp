...
class BaseEeyoreAST;
class ProgramAST_2;
class DeclAST; class InitAST; class FunDefAST_2;
class FunHeadAST; class StmtsAST; class FunEndAST;
//exp:
class BinaryAST; class UnaryAST; class AssignAST_2;
class IfAST_2; class GotoAST; class CallAST; class RetAST;
...
class BaseEeyoreAST{
    public:
        ASTtype type;
        FunDefAST_2* funcName; //指向该函数的FunDefAST
        virtual void generator(){};
        BaseEeyoreAST():type(BaseEeyore){};
};
class ProgramAST_2:public BaseEeyoreAST{
    public:
...
class DeclAST:public BaseEeyoreAST{
    public:
        ...
        int num;
        virtual void generator();
        DeclAST(string name, string num_, bool isTemp_):varName(name), num(string2num_2(num_)), \
...
class FunDefAST_2:public BaseEeyoreAST{
    public:
        BaseEeyoreAST* head;
        ...
        void DebugPrint();
        virtual void generator();
        FunDefAST_2(BaseEeyoreAST* p1, BaseEeyoreAST* p2, BaseEeyoreAST* p3): \
...
//todo
class AssignAST_2:public BaseEeyoreAST{
    public:
        /*
        ...
        */
        ...
        virtual void generator();
        //1
        AssignAST_2(string s1, RightValueAST* s2, int n):val1(s1),AssignType(n){type=Exp;val2=s2;val3=nullptr;}
        //2
        AssignAST_2(string s1, RightValueAST* s2, RightValueAST* s3, int n):val1(s1),AssignType(n){type=Exp;val2=s2;val3=s3;}
        //3
        AssignAST_2(string s1, string s2_, RightValueAST* s3, int n):val1(s1),AssignType(n) \
        {type=Exp;val3=s3;s2=s2_;}
        ~AssignAST_2(){};
};

//todo
class IfAST_2:public BaseEeyoreAST{
    public:
        ...
        string label;
        string op;
        IfAST_2(RightValueAST* s1, string op_, RightValueAST* s2, string label_): \
